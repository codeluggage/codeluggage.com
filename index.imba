...
app.get(/\.*/) do(req,res)
	...
	res.send String <html>
		<head>
			<meta charset="UTF-8">
			<title> "codeluggage - digital garden"
			<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
			<meta name="description" content="Hierarchical notes on philosophy, neurodiversity, programming, and making massive positive impact on humanity.">
			...
			<meta itemprop="name" content="codeluggage - digital garden">
			<meta itemprop="description" content="Hierarchical notes on philosophy, neurodiversity, programming, and making massive positive impact on humanity.">
			<meta itemprop="image" content="/images/social-card-preview.jpg">

			# <!-- Facebook Meta Tags -->
			<meta property="og:url" content="https://imba.io">
			<meta property="og:type" content="website">
			<meta property="og:title" content="codeluggage - digital garden">
			<meta property="og:description" content="Hierarchical notes on philosophy, neurodiversity, programming, and making massive positive impact on humanity.">
			<meta property="og:image" content="/images/social-card-preview.jpg">

			# <!-- Twitter Meta Tags -->
			<meta name="twitter:card" content="summary_large_image">
			<meta name="twitter:title" content="codeluggage - digital garden">
			<meta name="twitter:description" content="Hierarchical notes on philosophy, neurodiversity, programming, and making massive positive impact on humanity.">
